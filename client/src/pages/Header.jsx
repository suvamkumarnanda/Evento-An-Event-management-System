    ...
    <div>
      <header className='flex py-2 px-6 sm:px-6 justify-between place-items-center'>
          ...
          <Link to={'/'} className="flex item-center ">
            <img src="../src/assets/event image.png" alt="" className='w-20 h-7'/>
          </Link>
          <div  className='flex bg-white rounded py-2.5 px-4 w-3/3 gap-2 items-center shadow-md shadow-gray-200'>
          ...
          <Link to={'/createEvent'}> {/*TODO:Route create event page after creating it */}
            <div className='hidden md:flex flex-col place-items-center py-5 px-2 rounded text-primary cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
          ...
          <Link to={'/updateEvent'}> {/*TODO:Route create event page after creating it */}
            <div className='hidden md:flex flex-col place-items-center py-5 px-2 rounded text-primary cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
          
              <div className='font-bold color-primary text-sm items-center'>Update Event</div>
            </div>  
          </Link>
          ...
          <Link to={'/ticket'}> {/*TODO:Route wallet page after creating it */}
            <div className='hidden md:flex flex-col place-items-center py-5 px-2 rounded text-primary cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
                ...
                <div className='font-bold color-primary text-sm items-center'>Tickets</div>
            </div >
            </Link>
          ...
          {!!user &&(
            ...
            {/* TODO: */}
              <nav className={`block ${isMenuOpen ? 'block' : 'hidden'} `}>
                ...
                <Link className="flex hover:bg-background hover:shadow py-2 pl-6 pr-8 rounded-lg" to={'/ticket'}>
                  <div>Tickets</div>
                </Link>
